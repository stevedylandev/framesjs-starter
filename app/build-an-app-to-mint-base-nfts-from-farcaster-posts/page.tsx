    ...
    <div>
      ...
      >
        <FrameImage
          src={
            state.page === 1
              ? "https://dweb.mypinata.cloud/ipfs/QmYtj1bz2qyN3R2KdaoTFiHUfdSdMR5vuuuf9agwSAnnJ9/1.png"
              : `https://dweb.mypinata.cloud/ipfs/QmYtj1bz2qyN3R2KdaoTFiHUfdSdMR5vuuuf9agwSAnnJ9/${state.page}.png`
          }
        />
        {state.page !== 1 ? (
